...
HADC -ConfigurationData configdata.psd1 `
    -SafemodeAdministratorCred (Get-Credential -UserName Administrator -Message "Enter Domain Safe Mode Administrator Password") `
    -DomainAdministratorCred (Get-Credential -UserName localtestdomain\adminlocal -Message "Enter Domain Administrator Credential") `
