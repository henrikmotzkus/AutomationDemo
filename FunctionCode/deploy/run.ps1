...
#try {
    ...
    Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/henrikmotzkus/AutomationDemo/main/Subscription/azuredeploy.json' -Outfile 'c:\home\azuredeploy.json'
...
#    $body = "Deployment was not succrssfull"
